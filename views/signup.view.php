...
<div class="sm:mx-auto sm:w-full sm:max-w-sm">
  ...
  <form method='POST' class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    ...
    <div class="mb-6">
      ...
      <input name="confirm-password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="confirm-password" type="password" placeholder="************" required>
    ...
    <div class="flex items-center justify-between">
      ...
      <a class="inline-block align-baseline font-bold text-sm text-gray-700 hover:text-blue-800" href="/login">
        Already signed up ?
      </a>
    </div>
  </form>
